...
public class OI {
    ...
    public Joystick boulderHandlerGamePad;
    ...
    public OI() {
        ...
        boulderHandlerGamePad = new Joystick(1);
        
        driveGamePad = new Joystick(0);
        
        stopButton = new JoystickButton(driveGamePad, 1);
        stopButton.whenPressed(new StopRobot());
    ...
    public Joystick getBoulderHandlerGamePad() {
        return boulderHandlerGamePad;
    }
